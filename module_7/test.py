...
# Генеруємо всі можливі перестановки цифр від 0 до 9
permutations_list = list(permutations(range(10), 3))

# Виводимо матрицю
for i in range(0, len(permutations_list), 10):
    row = permutations_list[i:i+10]
    print(" ".join(map(lambda x: "".join(map(str, x)), row)))
...
input_matrix = [
    ...
    "903", "904", "905", "906", "907", "908", "909", "910", "912", "913",
    "914", "915", "916", "917", "918", "920", "921", "923", "924", "925",
    "926", "927", "928", "930", "931", "932", "934", "935", "936", "937",
    "938", "940", "941", "942", "943", "945", "946", "947", "948", "949",
    "950", "951", "952", "953", "954", "956", "957", "958", "959", "960",
    "961", "962", "963", "964", "965", "967", "968", "970", "971", "972",
    "973", "974", "975", "976", "978", "980", "981", "982", "983", "984",
    "985", "986", "987", "988", "989", "990", "991", "992", "993", "994",
    "995", "996", "997", "998", "999"
]

# Нова матриця для результатів
result_matrix = []

# Знаходимо елементи, які діляться на 26
...
# Виводимо результат
for i in range(0, len(result_matrix), 10):
    row = result_matrix[i:i+10]
    print(" ".join(row))
