...
# Експоненціальний розподіл є одним із найважливіших розподілів імовірності в теорії ймовірностей та статистиці. Цей розподіл використовується для моделювання часу між подіями, які відбуваються в деякому стохастичному процесі, якщо ці події відбуваються з незалежними та стаціонарними інтервалами. Назва "експоненціальний" пов'язана з експонентою, яка використовується для вираження ймовірності в цьому розподілі.
...
# формується 2 масиви: n - кількість елементів, що попали в інтервал, x - масив границь інтервалів
