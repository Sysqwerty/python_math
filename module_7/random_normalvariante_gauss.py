...
# Даному розподілу відповідає випадкова величина, яка являє собою суму великого числа незалежних випадкових величин, кожна з яких відіграє незначну роль в утворенні всієї суми. Тобто результати виборів, оцінки студентів за контрольну, результати випробувань снарядів відповідають нормальному розподілу, якщо на їх результати не впливали (тобто отримані результати незалежні).

# Нормальний розподіл також називають розподілом Гауса.
